...
class ModuleInstallerTest extends \OxidTestCase
{
    ...
    public function testActivateMixedChain()
    {
        ...
        $modulesAfter = ['OxidEsales\Eshop\Application\Model\Article' =>
                             ...
                             'OxidEsales\EshopCommunityTests\Integration\Modules\TestDataInheritance\modules\Vendor2\ModuleChainExtension37a\MyClass37a' . '&' .
                             'OxidEsales\EshopCommunityTests\Integration\Modules\TestDataInheritance\modules\Vendor1\ModuleChainExtension37b\MyClass37b' . '&' .
                             'OxidEsales\EshopCommunityTests\Integration\Modules\TestDataInheritance\modules'
                            ];
        ...
        $secondModule->setModuleData(['extend' => ['oxarticle' => 'OxidEsales\EshopCommunityTests\Integration\Modules\TestDataInheritance\modules\Vendor2\ModuleChainExtension37a\MyClass37a']]);
        ...
        $fourthExtends = array('oxArticle' => 'OxidEsales\EshopCommunityTests\Integration\Modules\TestDataInheritance\modules');
